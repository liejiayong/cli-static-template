...
f.define("button.verifty",function(e){function d(a){a=e.validate.isObject(a)?a:{};this.target=e.validate.isNode(a.target)?a.target:document.querySelector(a.target);this.current=0;this.duration=e.validate.isNumber(a.duration)?a.duration:d.DEFAULT.duration;this.unit=a.unit||d.DEFAULT.unit;this.text=a.text||d.DEFAULT.text;this.textActive=a.textActive||d.DEFAULT.textActive;this.disableClass=a.disableClass||d.DEFAULT.disableClass;this.async=e.validate.isBoolean(a.async)?a.async:d.DEFAULT.async;this.onStart=
...
target:".u-toasts__text",message:"",duration:1E3,outTime:200,zIndex:1E3},a=$('<div class="u-toasts__box" id="sysToasts"><span class="u-toasts__text"></span></div>');e.$(e.document).append(a);e.utils.createStyle("@-webkit-keyframes bounceIn{0%{opacity:0;-webkit-transform:scale(0.5);-ms-transform:scale(0.5);transform:scale(0.5)}100%{opacity:1;-webkit-transform:scale(1);-ms-transform:scale(1);transform:scale(1)}}@-moz-keyframes bounceIn{0%{opacity:0;-webkit-transform:scale(0.5);-ms-transform:scale(0.5);-moz-transform:scale(0.5);transform:scale(0.5)}100%{opacity:1;-webkit-transform:scale(1);-ms-transform:scale(1);-moz-transform:scale(1);transform:scale(1)}}@keyframes bounceIn{0%{opacity:0;-webkit-transform:scale(0.5);-ms-transform:scale(0.5);-moz-transform:scale(0.5);-o-transform:scale(0.5);transform:scale(0.5)}100%{opacity:1;-webkit-transform:scale(1);-ms-transform:scale(1);-moz-transform:scale(1);-o-transform:scale(1);transform:scale(1)}}@-webkit-keyframes bounceOut{100%{opacity:0;-webkit-transform:scale(0.7);-ms-transform:scale(0.7);transform:scale(0.7)}30%{-webkit-transform:scale(1.05);-ms-transform:scale(1.05);transform:scale(1.05)}0%{-webkit-transform:scale(1);-ms-transform:scale(1);transform:scale(1)}}@-moz-keyframes bounceOut{100%{opacity:0;-webkit-transform:scale(0.7);-ms-transform:scale(0.7);-moz-transform:scale(0.7);transform:scale(0.7)}30%{-webkit-transform:scale(1.05);-ms-transform:scale(1.05);-moz-transform:scale(1.05);transform:scale(1.05)}0%{-webkit-transform:scale(1);-ms-transform:scale(1);-moz-transform:scale(1);transform:scale(1)}}@keyframes bounceOut{100%{opacity:0;-webkit-transform:scale(0.7);-ms-transform:scale(0.7);-moz-transform:scale(0.7);-o-transform:scale(0.7);transform:scale(0.7)}30%{-webkit-transform:scale(1.05);-ms-transform:scale(1.05);-moz-transform:scale(1.05);-o-transform:scale(1.05);transform:scale(1.05)}0%{-webkit-transform:scale(1);-ms-transform:scale(1);-moz-transform:scale(1);-o-transform:scale(1);transform:scale(1)}}.u-toasts__box{display:none;position:fixed;top:30%;left:50%;-webkit-transform:translateX(-50%);-moz-transform:translateX(-50%);-ms-transform:translateX(-50%);-o-transform:translateX(-50%);transform:translateX(-50%);white-space:nowrap;z-index:1000}.u-toasts__box .u-toasts__text{display:inline-block;padding:.8em 1.2em;font-size:18px;-webkit-box-shadow:#000 0px 0px 2px;box-shadow:#000 0px 0px 2px;background-color:#000;filter:alpha(opacity=60);background-color:rgba(0,0,0,.6);color:#fff}.u-toasts__box.is-open{display:block}.u-toasts__box.is-open .u-toasts__text{-webkit-animation:bounceIn .2s ease-in both;-moz-animation:bounceIn .2s ease-in both;animation:bounceIn .2s ease-in both}.u-toasts__box.is-close{display:block}.u-toasts__box.is-close .u-toasts__text{-webkit-animation:bounceOut .2s ease-in both;-moz-animation:bounceOut .2s ease-in both;animation:bounceOut .2s ease-in both}");
return function(b){var c=e.utils.deepClone(d);e.validate.isObject(b)?e.extend(c,b):c.message=b;a.css({zIndex:c.zIndex}).addClass(c.openClass).removeClass(c.closeClass).find(c.target).text(c.message);e.utils.delay(function(){a.addClass(c.closeClass).removeClass(c.openClass)},c.duration).then(function(){e.utils.delay(function(){a.removeClass(c.closeClass)},c.outTime)})}});f.define("Loading",function(e){function d(a){this.opts=a=a||{duration:0};this.doc=document.documentElement.body||document.body;this.target=
a.target||this.doc;this.text=a.text||"\u52a0\u8f7d\u4e2d...";this.background=a.background||"";this.color=a.color||"";this.zIndex="number"===typeof a.zIndex?a.zIndex:200;this.duration="number"===typeof a.duration?a.duration:3E3;this.icon=a.icon||'<svg version="1.1" id="icoLoader" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="40px" height="40px" viewBox="0 0 50 50" style="enable-background:new 0 0 50 50;" xml:space="preserve"><path fill="#fff" d="M43.935,25.145c0-10.318-8.364-18.683-18.683-18.683c-10.318,0-18.683,8.365-18.683,18.683h4.068c0-8.071,6.543-14.615,14.615-14.615c8.072,0,14.615,6.543,14.615,14.615H43.935z"><animateTransform attributeType="xml" attributeName="transform" type="rotate" from="0 25 25" to="360 25 25" dur="0.6s" repeatCount="indefinite"></animateTransform></path></svg>';
...
d}});f.define("navTo",function(e){return function(d,a){a=a||".jy-section";$(d).addClass(this.activeCls).siblings(a).removeClass(this.activeCls)}});q.JTool=q._JTool_=f}(window,document);
      ...
      function initUI() {
        ...
        params.data.forEach(function (value) {
          ...
          params.column.forEach(function (head) {
            var data = value[head.key] || "",
              typeKey = value[head.typeKey];
