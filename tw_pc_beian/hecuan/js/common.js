$(function () {
  ...
  var profile = '海南娇云网络科技有限公司',
    address = '海南省海口市江东新区琼山大道86号江东产业园加速楼103-BY103';
  ...
  var foot =
    ...
    '</p>' +
    '<p>' +
    '<a href="./img/benan.jpg" target="_blank">公司名称: ' +
    profile +
    '</a> |' +
    '<a href="http://www.beian.miit.gov.cn" target="_blank">ICP备案号:<span id="icp">琼ICP备2021000983号</span>号 </a>' +
    '</p>' +
    '<p>' +
    '<a href="" target="_blank">地址：' +
    address +
    '</a> |' +
  ...
  switch (url) {
    case 'jiaoyunn':
      icp.text('琼ICP备2021000983号-1');
      web.text('www.jiaoyunn.com');
      break;
    case 'jiaoyunv':
      icp.text('琼ICP备2021000983号-2');
      web.text('www.jiaoyunv.com');
      break;
    case 'jiaoyunw':
      icp.text('琼ICP备2021000983号-3');
      web.text('www.jiaoyunw.com');
      break;
    case 'jiaoyunc':
      icp.text('琼ICP备2021000983号-4');
      web.text('www.jiaoyunc.com');
      break;
    default:
  }
  ...
  var sidebarTxt =
    ...
    '<div class="content">' +
    '  <menu>' +
    '	<li><span class="ico"></span><b>公司名称:</b><span> ' +
    profile +
    '</span></li>' +
    '	<li><span class="ico"></span><b>ICP备案号:</b><span><a href="http://www.beian.miit.gov.cn" target="_blank">琼ICP备2021000983号</a></span></li>' +
    '	<li><span class="ico"></span><b>地址:</b><span><a href="####"></a>' +
    address +
    '</span>' +
    '	</li>' +
    '	<li><span class="ico"></span><b>电子邮箱:</b><span><a' +
    '		  href="mailto: leeruige@163.com">leeruige@163.com(李锐戈)</a></span></li>' +
    '	<li><span class="ico"></span><b>联系电话:</b><span><a href="tel: 16624759754">16624759754</a></span></li>' +
